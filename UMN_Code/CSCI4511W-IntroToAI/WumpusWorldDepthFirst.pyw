...
noWumpus = []
arrows = 1
order = [(3,0),(2,0),(1,0),(0,0),(3,1),(3,2),(3,3),(2,1),\
         (1,1),(0,1),(2,2),(2,3),(1,2),(0,2),(1,3),(0,3)]
futureMoves = []
replaced = False
...
def dfPlay(senses):
    ...
    if "Glitter" in senses: action = "pick up gold"
        ...
        if coords == order[0]: order.pop(0)
        try: action = directionsToTarget(order[0])
        except IndexError: print("order empty?",len(order))
